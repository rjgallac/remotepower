...
docker run -d --restart always -e SSH_USER=xxx -e SSH_PASSWORD=xxx --network host -e PORT=3001 --name remotepower ghcr.io/rjgallac/remotepower/remotepower:0.0.1 
